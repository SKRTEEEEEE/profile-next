  ...
  if (!project) {
    return (
      <main className="min-h-dvh w-dvw flex flex-col gap-4 items-center justify-center">
        ...
        <Link href="/proyectos" className="px-8 mt-8 py-2 border-primary-ceo-200/80 hover:bg-primary-ceo-500/20 hover:border-primary-ceo-300 border-4 rounded-md bg-primary-ceo-700 ">Volver a la página de proyectos</Link>
      </main>
    );
  }
  return (
